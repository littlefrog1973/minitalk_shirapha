...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/21 21:43:45 by shirapra          #+#    #+#             */
/*   Updated: 2022/08/24 01:53:50 by shirapra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	specifierx_xp(char c, va_list lst, char *s, size_t strsize)
{
	if (c == 'x' || c == 'X')
	{
...
static int	specifieridu(char c, va_list lst, char *s, size_t strsize)
{
	...
	else if (c == 'u')
	{
		...
		return (specifierx_xp(c, lst, s, 0));
}
